...
The distributions of both of the plots above appears to be normal. The median of the log(β0∗β1) value is `r round(median(pull(bootstrap_results, log_b0b1)), digits=2)`, and the mean is `r round(mean(pull(bootstrap_results, log_b0b1)), digits=2)`. The median of the r2 value is `r round(median(pull(bootstrap_results, r2)), digits=2)`, and the mean is `r round(mean(pull(bootstrap_results, r2)), digits=2)`. 
